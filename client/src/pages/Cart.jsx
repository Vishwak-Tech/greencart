...
const Cart = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row mt-16">
            ...
            {/* RIGHT SIDE */}
            <div className="max-w-[360px] w-full bg-gray-100 p-5 border ml-6 max-md:ml-0 max-md:mt-10">
                    ...
                    {showAddress && (
                        ...
                        <div className="absolute top-12 bg-white border w-full z-10">
                            ...
                            <p
                                ...
                                className="text-primary text-center p-2 cursor-pointer hover:bg-primary/10"
                            >
                                Add Address
                            </p>
                ...
                <p className="text-sm uppercase font-medium mt-6">
                    Payment Method
                </p>
            ...
            <button
                ...
                className="w-full bg-primary text-white py-3 mt-6 hover:bg-primary-dull disabled:opacity-50"
                >
                {paymentOption === "COD"
                    ? "Place Order"
...
//     // Build cart array safely (no mutation)
//     const getCart = () => {
//         let tempArray = [];
